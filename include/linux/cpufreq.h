...
#elif defined(CONFIG_CPU_FREQ_DEFAULT_GOV_INTELLIPLUG)
extern struct cpufreq_governor cpufreq_gov_intelliplug;
#define CPUFREQ_DEFAULT_GOVERNOR    (&amp;cpufreq_gov_intellipug)
